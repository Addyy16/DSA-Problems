class IshaanLovesChocolates {
  ...
  public static void main(String args[]){
    int[] arr = {5, 3, 1, 6, 9};
    System.out.println(chocolates(n, arr));
  }
}
...
// Your Task:
// This is a function problem. The input is already taken care of by the driver code. You only need to complete the function chocolates() that takes an array (arr), sizeOfArray (n) and return the tastiness level 
// of the square which his sister gets. The driver code takes care of the printing.
